...
/**
    ...
    and, optionally, whether a lambda expression invoked with the inner union
    is true or not.
...
/**
    ...
    generates a metafunction called "has_union_'name'" where 'name' is the macro parameter.
